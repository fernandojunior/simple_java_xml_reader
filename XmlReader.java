...
/**
 *
 * Xml Reader, Classe que define um leitor de arquivos xml
 *
...
public class XmlReader {
	 ...
	 */
	public ArrayList<Element> toArrayList(NodeList nodeList) {
	 ...
	 */
	public ArrayList<Element> getChildren(Node node) {
	 ...
	 */
	public ArrayList<Element> getChildren(Node node, String name) {

		NodeList nodes = toElement(node).getElementsByTagName(name);
	 ...
	 * o nome de elemento, na qual, servira de filtro, para que o metodo retorne
	 * apenas o primeiro elemento filho que possua esse mesmo nome
	 * 
	 * @param element
	 *            O elemento pai a ser passado como parametro
	 * @param elementName
	...
	/**
	 * Metodo que retorna um elemento filho (o primeiro de indice 0, caso exista
	 * outros com o mesmo nome) conforme o no pai passado como parametro e o
	 * nome de elemento, na qual, servira de filtro, para que o metodo retorne
	 * apenas o primeiro elemento filho que possua esse mesmo nome
	 * 
	 * @param node
	 *            O no pai a ser passado como parametro
	 * @param elementName
	 *            O nome de elemento que servira de filtro
	 * @return O elemento filho
	 */
	public Element getChild(Node node, String name) {

		return getChildren(node, name).get(0);
